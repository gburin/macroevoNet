...
posterior.raw.plot.lambdamu.raw$pi.x <- NA
posterior.raw.plot.lambdamu.raw$pi.x <- seq(0, 10)[match(posterior.raw.plot.lambdamu$variable, levels(posterior.raw.plot.lambdamu$variable)[c(1, 3, 2, 4:6, 9:10, 7:8)])]
